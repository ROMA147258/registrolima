-- ============================================================================
-- MIGRACIÓN 006: Creación de las tablas rcoordinadoresz / rcoordinadorz (Coordinador Zonal)
-- Almacena a los coordinadores zonales con asignación múltiple de colegios
-- ============================================================================

-- 1. POSTGRESQL (Tablas: rcoordinadoresz y rcoordinadorz)
...
CREATE INDEX IF NOT EXISTS idx_rcoordinadorz_dni ON rcoordinadorz(dni);
CREATE INDEX IF NOT EXISTS idx_rcoordinadorz_distrito ON rcoordinadorz(distrito_asignado);
